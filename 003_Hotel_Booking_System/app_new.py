...
def book(room_id):
    ...
    if request.method == 'POST':
        ...
        ''', (room_id, check_out_date, check_in_date, check_in_date, check_out_date, check_in_date, check_out_date))
        ...
        # Create booking
        c.execute('''
            INSERT INTO bookings (user_id, room_id, check_in_date, check_out_date, num_guests, total_price, special_requests)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        ''', (session['user_id'], room_id, check_in_date, check_out_date, guests, total_price, special_requests))
